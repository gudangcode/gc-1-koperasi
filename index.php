...
<?php
    ...
    switch ($pilih) {
        ...
        case "4.3":
            ...
            break;
        case "4.4":
            $tampil = "pengajuan/pengajuan.php";
            break;
        case "4.5":
            $tampil = "help.php";
            break;
        ...
        case "4.7":
            ...
            break;
        case "4.8":
            $tampil = "laporan/perbulan.php";
            break;
        case "4.9":
            $tampil = "laporan/keuangan.php";
            break;
    } //tutup switch
?>
      ...
      *********************************************************************************************************************************************************** -->
            ...
            <aside>
                <div id="sidebar" class="nav-collapse ">
                    ...
                    ?>
                    <hr>
                    <center>Distributed by <a href="https://gudangcode.com/" target="_blank" rel="noopener noreferrer">Gudangcode</a>
                    </center>
                    <!-- sidebar menu end-->
                </div>
            </aside>
